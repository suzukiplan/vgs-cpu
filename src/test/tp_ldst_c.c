...
{
    unsigned char op1[] = {VGSCPU_OP_LD_C_1, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_LD_C_2, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_C_4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_LD_C_A, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_LD_C_B, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_LD_C_D, VGSCPU_OP_BRK};
    unsigned char op7[] = {VGSCPU_OP_ST_C_M1, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op8[] = {VGSCPU_OP_ST_C_M2, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op9[] = {VGSCPU_OP_ST_C_M4, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op10[] = {VGSCPU_OP_LD_C_RM, VGSCPU_OP_BRK};
    unsigned char op11[] = {VGSCPU_OP_LD_C_RM, 0x00, VGSCPU_OP_BRK};
    unsigned char op12[] = {VGSCPU_OP_LD_C_RM, 0x01, VGSCPU_OP_BRK};
    unsigned char op13[] = {VGSCPU_OP_LD_C_RM, 0x02, VGSCPU_OP_BRK};
    unsigned char op14[] = {VGSCPU_OP_LD_C_RM, 0x03, VGSCPU_OP_BRK};
    unsigned char op15[] = {VGSCPU_OP_LD_C_RM, 0x04, VGSCPU_OP_BRK};
    unsigned char op16[] = {VGSCPU_OP_LD_C_RM, 0x11, VGSCPU_OP_BRK};
    unsigned char op17[] = {VGSCPU_OP_LD_C_RM, 0x12, VGSCPU_OP_BRK};
    unsigned char op18[] = {VGSCPU_OP_LD_C_RM, 0x13, VGSCPU_OP_BRK};
    unsigned char op19[] = {VGSCPU_OP_LD_C_RM, 0x14, VGSCPU_OP_BRK};
    unsigned char op20[] = {VGSCPU_OP_LD_C_RM, 0x21, VGSCPU_OP_BRK};
    unsigned char op21[] = {VGSCPU_OP_LD_C_RM, 0x22, VGSCPU_OP_BRK};
    unsigned char op22[] = {VGSCPU_OP_LD_C_RM, 0x23, VGSCPU_OP_BRK};
    unsigned char op23[] = {VGSCPU_OP_LD_C_RM, 0x24, VGSCPU_OP_BRK};
    unsigned char op24[] = {VGSCPU_OP_LD_C_RM, 0x31, VGSCPU_OP_BRK};
    unsigned char op25[] = {VGSCPU_OP_LD_C_RM, 0x32, VGSCPU_OP_BRK};
    unsigned char op26[] = {VGSCPU_OP_LD_C_RM, 0x33, VGSCPU_OP_BRK};
    unsigned char op27[] = {VGSCPU_OP_LD_C_RM, 0x34, VGSCPU_OP_BRK};
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($21)"), 0);

    vgscpu_load_program(c, op21, sizeof(op21));
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($22)"), 0);
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($24)"), 0);
...
int test_main_memory(struct vgscpu_context *c)
{
    ...
    unsigned char op4[] = {VGSCPU_OP_ST_C_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
...
int test_ld_c_literal(struct vgscpu_context *c)
{
    ...
    unsigned char op2[] = {VGSCPU_OP_LD_C_2, 0xAB, 0xCD, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_C_4, 0x67, 0x89, 0xAB, 0xCD, VGSCPU_OP_BRK};

    vgscpu_load_program(c, op1, sizeof(op1));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0xCD);

    vgscpu_load_program(c, op2, sizeof(op2));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0xCDAB);

    vgscpu_load_program(c, op3, sizeof(op3));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0xCDAB8967);
    return 0;
}
...
int test_ld_c_registry(struct vgscpu_context *c)
{
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0x01020304);
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0x05060708);
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.c, 0x090a0b0c);
    return 0;
}
...
int main()
{
    ...
    if (test_ld_c_literal(c)) goto END_TEST;
    if (test_ld_c_registry(c)) goto END_TEST;
    if (test_ld_c_memory(c)) goto END_TEST;
    if (test_st_c(c)) goto END_TEST;
