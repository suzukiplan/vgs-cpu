...
int test_program_memory_1(struct vgscpu_context *c)
{
    unsigned char op1[] = {VGSCPU_OP_JMP_1, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_JMP_1, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_JMP_1, 0x01, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_JMP_1, 0x02, VGSCPU_OP_BRK};
...
int test_program_memory_2(struct vgscpu_context *c)
{
    unsigned char op1[] = {VGSCPU_OP_JMP_2, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_JMP_2, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_JMP_2, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_JMP_2, 0x01, 0x00, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_JMP_2, 0x02, 0x00, VGSCPU_OP_BRK};
...
int main()
{
    ...
    if (test_program_memory_1(c)) goto END_TEST;
    if (test_program_memory_2(c)) goto END_TEST;
