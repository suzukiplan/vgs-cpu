...
{
    unsigned char op1[] = {VGSCPU_OP_LD_B_1, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_LD_B_2, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_B_4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_LD_B_A, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_LD_B_C, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_LD_B_D, VGSCPU_OP_BRK};
    unsigned char op7[] = {VGSCPU_OP_ST_B_M1, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op8[] = {VGSCPU_OP_ST_B_M2, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op9[] = {VGSCPU_OP_ST_B_M4, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op10[] = {VGSCPU_OP_LD_B_RM, VGSCPU_OP_BRK};
    unsigned char op11[] = {VGSCPU_OP_LD_B_RM, 0x00, VGSCPU_OP_BRK};
    unsigned char op12[] = {VGSCPU_OP_LD_B_RM, 0x01, VGSCPU_OP_BRK};
    unsigned char op13[] = {VGSCPU_OP_LD_B_RM, 0x02, VGSCPU_OP_BRK};
    unsigned char op14[] = {VGSCPU_OP_LD_B_RM, 0x03, VGSCPU_OP_BRK};
    unsigned char op15[] = {VGSCPU_OP_LD_B_RM, 0x04, VGSCPU_OP_BRK};
    unsigned char op16[] = {VGSCPU_OP_LD_B_RM, 0x11, VGSCPU_OP_BRK};
    unsigned char op17[] = {VGSCPU_OP_LD_B_RM, 0x12, VGSCPU_OP_BRK};
    unsigned char op18[] = {VGSCPU_OP_LD_B_RM, 0x13, VGSCPU_OP_BRK};
    unsigned char op19[] = {VGSCPU_OP_LD_B_RM, 0x14, VGSCPU_OP_BRK};
    unsigned char op20[] = {VGSCPU_OP_LD_B_RM, 0x21, VGSCPU_OP_BRK};
    unsigned char op21[] = {VGSCPU_OP_LD_B_RM, 0x22, VGSCPU_OP_BRK};
    unsigned char op22[] = {VGSCPU_OP_LD_B_RM, 0x23, VGSCPU_OP_BRK};
    unsigned char op23[] = {VGSCPU_OP_LD_B_RM, 0x24, VGSCPU_OP_BRK};
    unsigned char op24[] = {VGSCPU_OP_LD_B_RM, 0x31, VGSCPU_OP_BRK};
    unsigned char op25[] = {VGSCPU_OP_LD_B_RM, 0x32, VGSCPU_OP_BRK};
    unsigned char op26[] = {VGSCPU_OP_LD_B_RM, 0x33, VGSCPU_OP_BRK};
    unsigned char op27[] = {VGSCPU_OP_LD_B_RM, 0x34, VGSCPU_OP_BRK};
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($11)"), 0);

    vgscpu_load_program(c, op17, sizeof(op17));
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($12)"), 0);
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($14)"), 0);
...
int test_main_memory(struct vgscpu_context *c)
{
    ...
    unsigned char op1[] = {VGSCPU_OP_LD_B_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_LD_B_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_B_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_ST_B_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_ST_B_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_ST_B_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
