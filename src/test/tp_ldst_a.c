...
{
    unsigned char op1[] = {VGSCPU_OP_LD_A_1, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_LD_A_2, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_A_4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_LD_A_B, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_LD_A_C, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_LD_A_D, VGSCPU_OP_BRK};
    unsigned char op7[] = {VGSCPU_OP_ST_A_M1, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op8[] = {VGSCPU_OP_ST_A_M2, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op9[] = {VGSCPU_OP_ST_A_M4, 0x08, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op10[] = {VGSCPU_OP_LD_A_RM, VGSCPU_OP_BRK};
    unsigned char op11[] = {VGSCPU_OP_LD_A_RM, 0x00, VGSCPU_OP_BRK};
    unsigned char op12[] = {VGSCPU_OP_LD_A_RM, 0x01, VGSCPU_OP_BRK};
    unsigned char op13[] = {VGSCPU_OP_LD_A_RM, 0x02, VGSCPU_OP_BRK};
    unsigned char op14[] = {VGSCPU_OP_LD_A_RM, 0x03, VGSCPU_OP_BRK};
    unsigned char op15[] = {VGSCPU_OP_LD_A_RM, 0x04, VGSCPU_OP_BRK};
    unsigned char op16[] = {VGSCPU_OP_LD_A_RM, 0x11, VGSCPU_OP_BRK};
    unsigned char op17[] = {VGSCPU_OP_LD_A_RM, 0x12, VGSCPU_OP_BRK};
    unsigned char op18[] = {VGSCPU_OP_LD_A_RM, 0x13, VGSCPU_OP_BRK};
    unsigned char op19[] = {VGSCPU_OP_LD_A_RM, 0x14, VGSCPU_OP_BRK};
    unsigned char op20[] = {VGSCPU_OP_LD_A_RM, 0x21, VGSCPU_OP_BRK};
    unsigned char op21[] = {VGSCPU_OP_LD_A_RM, 0x22, VGSCPU_OP_BRK};
    unsigned char op22[] = {VGSCPU_OP_LD_A_RM, 0x23, VGSCPU_OP_BRK};
    unsigned char op23[] = {VGSCPU_OP_LD_A_RM, 0x24, VGSCPU_OP_BRK};
    unsigned char op24[] = {VGSCPU_OP_LD_A_RM, 0x31, VGSCPU_OP_BRK};
    unsigned char op25[] = {VGSCPU_OP_LD_A_RM, 0x32, VGSCPU_OP_BRK};
    unsigned char op26[] = {VGSCPU_OP_LD_A_RM, 0x33, VGSCPU_OP_BRK};
    unsigned char op27[] = {VGSCPU_OP_LD_A_RM, 0x34, VGSCPU_OP_BRK};
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($01)"), 0);

    vgscpu_load_program(c, op13, sizeof(op13));
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($02)"), 0);
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), -1);
    TEST(__FILE__, __LINE__, strcmp(c->error, "INVALID ARGUMENT($04)"), 0);
...
int test_main_memory(struct vgscpu_context *c)
{
    ...
    unsigned char op1[] = {VGSCPU_OP_LD_A_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_LD_A_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_LD_A_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_ST_A_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_ST_A_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_ST_A_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
...
int test_ld_a_literal(struct vgscpu_context *c)
{
    ...
    vgscpu_load_program(c, op1, sizeof(op1));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0xCD);

    vgscpu_load_program(c, op2, sizeof(op2));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0xCDAB);

    vgscpu_load_program(c, op3, sizeof(op3));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0xCDAB8967);
    return 0;
}
...
int test_ld_a_registry(struct vgscpu_context *c)
{
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0x01020304);
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0x05060708);
    ...
    c->r.d = 0x090a0b0c;
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0x090a0b0c);
    return 0;
}
...
int test_ld_a_memory(struct vgscpu_context *c)
{
    ...
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0x8);

    vgscpu_load_program(c, op2, sizeof(op2));
    memcpy(c->m, m, sizeof(m));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0x908);

    vgscpu_load_program(c, op3, sizeof(op3));
    memcpy(c->m, m, sizeof(m));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.a, 0xb0a0908);
    return 0;
}
