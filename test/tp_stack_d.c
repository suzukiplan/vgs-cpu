...
{
    unsigned char op1[] = {VGSCPU_OP_PUSH_D1, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_PUSH_D2, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_PUSH_D4, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_PUSH_D1, VGSCPU_OP_POP_D1, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_PUSH_D2, VGSCPU_OP_POP_D2, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_PUSH_D4, VGSCPU_OP_POP_D4, VGSCPU_OP_BRK};
...
{
    unsigned char op1[] = {VGSCPU_OP_POP_D1, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_POP_D2, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_POP_D4, VGSCPU_OP_BRK};
