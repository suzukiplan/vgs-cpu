...
{
    unsigned char op1[] = {VGSCPU_OP_PUSH_B1, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_PUSH_B2, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_PUSH_B4, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_PUSH_B1, VGSCPU_OP_POP_B1, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_PUSH_B2, VGSCPU_OP_POP_B2, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_PUSH_B4, VGSCPU_OP_POP_B4, VGSCPU_OP_BRK};
...
int test_pop1(struct vgscpu_context *c)
{
    ...
    vgscpu_load_program(c, op, sizeof(op));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.b, 0x78);
...
int test_pop2(struct vgscpu_context *c)
{
    ...
    vgscpu_load_program(c, op, sizeof(op));
    TEST(__FILE__, __LINE__, vgscpu_run(c), 0);
    TEST(__FILE__, __LINE__, c->r.b, 0x5678);
    TEST(__FILE__, __LINE__, c->r.s, 0);
    return 0;
}
...
{
    unsigned char op1[] = {VGSCPU_OP_POP_B1, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_POP_B2, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_POP_B4, VGSCPU_OP_BRK};
