...
{
    unsigned char op1[] = {VGSCPU_OP_ADD_A_1, 0x00, VGSCPU_OP_BRK};
    unsigned char op2[] = {VGSCPU_OP_ADD_A_2, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op3[] = {VGSCPU_OP_ADD_A_4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op4[] = {VGSCPU_OP_ADD_A_B, VGSCPU_OP_BRK};
    unsigned char op5[] = {VGSCPU_OP_ADD_A_C, VGSCPU_OP_BRK};
    unsigned char op6[] = {VGSCPU_OP_ADD_A_D, VGSCPU_OP_BRK};
    unsigned char op7[] = {VGSCPU_OP_ADD_A_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op8[] = {VGSCPU_OP_ADD_A_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned char op9[] = {VGSCPU_OP_ADD_A_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
...
int test_add_a_2(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_ADD_A_2, 0xff, 0xff, VGSCPU_OP_BRK};
...
int test_add_a_4(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_ADD_A_4, 0xff, 0xff, 0xff, 0xff, VGSCPU_OP_BRK};
...
int test_add_a_b(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_LD_B_1, 0xff, VGSCPU_OP_ADD_A_B, VGSCPU_OP_BRK};
...
int test_add_a_c(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_LD_C_1, 0xfe, VGSCPU_OP_ADD_A_C, VGSCPU_OP_BRK};
...
int test_add_a_d(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_LD_D_1, 0xfd, VGSCPU_OP_ADD_A_D, VGSCPU_OP_BRK};
...
int test_add_a_m1(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_ADD_A_M1, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
...
int test_add_a_m2(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_ADD_A_M2, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned int i = 0xffffffff;
...
int test_add_a_m4(struct vgscpu_context *c)
{
    unsigned char op[] = {VGSCPU_OP_ADD_A_M4, 0x00, 0x00, 0x00, 0x00, VGSCPU_OP_BRK};
    unsigned int i = 0xffffffff;
...
int main()
{
    ...
    if (test_add_a_b(c)) goto END_TEST;
    if (test_add_a_c(c)) goto END_TEST;
    if (test_add_a_d(c)) goto END_TEST;
    if (test_add_a_m1(c)) goto END_TEST;
    if (test_add_a_m2(c)) goto END_TEST;
    if (test_add_a_m4(c)) goto END_TEST;
